...
class Cause extends \Magento\Framework\App\Action\Action
{
	...
	public function __construct(
		...
		public function execute() {
			...
			if ( !empty($motivation) )
				$product_url = self::add_query_arg( $product_url, 'motivation',$motivation );

			if ( !empty($amount) )
				$product_url = self::add_query_arg( $product_url, 'amount',$amount );		
		...
		public static function add_query_arg($url, $key, $value) {
